...
#             return render_template("index.html", preds=json.dumps(bgs_freq[(string)].most_common(5)))
            
            
          
#         elif n>1:
#             #print (tgs_freq[(words[n-2],words[n-1])].most_common(5),file=sys.stderr)
#             return render_template("index.html", preds=json.dumps(tgs_freq[(words[n-2],words[n-1])].most_common(5)))
#     else:
#         return render_template("index.html", preds=json.dumps(incomplete_pred(words, n)))

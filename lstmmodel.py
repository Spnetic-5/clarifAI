...
model.add(LSTM(50, return_sequences=True)) # 1st LSTM layer with 100 hidden layers
model.add(Dropout(0.2))
model.add(LSTM(50)) # 2nd LSTM layer with 100 hidden layers
model.add(Dense(50, activation='relu'))  #Dense layer with 100 neurons and relu activation
